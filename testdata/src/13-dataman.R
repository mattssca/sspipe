...
mdup.list = list.files(path = "./testdata/out/metrics/mdup/", 
                       recursive = TRUE,
                       pattern = "\\.txt$", 
                       full.names = TRUE)
...
# List all txt files including sub-folders
colal.list = list.files(path = "./testdata/out/metrics/CollectAlignmentMetrics/", 
                        recursive = TRUE,
                        pattern = "\\.txt$", 
                        full.names = TRUE)
...
write.table(x = alignmentMetrics, file = "./testdata/out/metrics/alignmentmetrics.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
